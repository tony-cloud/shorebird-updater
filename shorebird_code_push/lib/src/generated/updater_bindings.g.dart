...
class UpdaterBindings {
  ...
  bool shorebird_check_for_downloadable_update(
    ...
    return _shorebird_check_for_downloadable_update(c_channel);
  }
  ...
  bool shorebird_set_device_id_override(ffi.Pointer<ffi.Char> c_device_id) {
    return _shorebird_set_device_id_override(c_device_id);
  }

  late final _shorebird_set_device_id_overridePtr =
      _lookup<ffi.NativeFunction<ffi.Bool Function(ffi.Pointer<ffi.Char>)>>(
        'shorebird_set_device_id_override',
      );
  late final _shorebird_set_device_id_override =
      _shorebird_set_device_id_overridePtr
          .asFunction<bool Function(ffi.Pointer<ffi.Char>)>();
  ...
  ffi.Pointer<UpdateResult> shorebird_update_with_result(
    ...
    return _shorebird_update_with_result(c_channel);
  }
  ...
  void shorebird_free_update_result(ffi.Pointer<UpdateResult> result) {
    return _shorebird_free_update_result(result);
  }
